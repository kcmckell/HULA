...
/*
Template Name: Fall 2013
 * 
 * @file           page-league-Fa13.php
...
function league_scripts(){
  ...
  echo '<script>var LV_api_url = "'.HULA_LEAGUEVINE_API_URL.'", LV_access_token = "'.HULA_LEAGUEVINE_ACCESS_TOKEN.'";</script>';
}
