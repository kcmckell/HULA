...
<title>Raucous Registration</title>
...
<!--#include file="../include/hulamenu.inc"-->
  ...
  <div id=hula_menu_image>
   <img src="../images/RaucousCaucus.jpg" width="680" height="120" />
  </div>

  <div id=hula_content>
   <div id=hula_story>

    <div id=hula_story_header>Raucous Caucus Registration</div>
    <div id=hula_story_text>

     <!--#include file="../include/raucous_register.inc"-->
