...
elseif (Request.Form("teamname") = "blank") then
  ...
  <%
elseif (Request.Form("tshirt") = "") then
  %>
  <center>
   <br><b>Error Encountered</b>
   <p>Please go back and enter your Tshirt Size.
   <p><input type="button" onClick="history.back()" value="Go back">
   <br><br>
  </center>
  <%
elseif (Request.Form("diet") = "") then
  ...
  <%
elseif (Request.Form("waiver") = "") then
  %>
  <center>
   <br><b>Error Encountered</b>
   <p>Please go back and accept the waiver.
   <p><input type="button" onClick="history.back()" value="Go back">
   <br><br>
  </center>
  <%
...
RegMailer.Subject = "Kaimana XXI Registration - " + Request.Form("firstname") + " " + Request.Form("lastname")
...
RegMailer.TextBody = RegMailer.TextBody + ":" + Request.Form("tshirt")
...
ConfMailer.Subject = "Kaimana XXI Registration Confirmation"
ConfMailer.TextBody = "Thank you for registering for the Kaimana XXI!" + vbcrlf
...
ConfMailer.TextBody = ConfMailer.TextBody + "http://www.hawaiiultimate.com/kk/kk21" + vbcrlf

ConfMailer.TextBody = ConfMailer.TextBody + " " + vbcrlf
ConfMailer.TextBody = ConfMailer.TextBody + "See you on the fields!" + vbcrlf
ConfMailer.TextBody = ConfMailer.TextBody + "Lisa and Jena - Kaimana TD's" + vbcrlf
ConfMailer.TextBody = ConfMailer.TextBody + " " + vbcrlf
...
ConfMailer.TextBody = ConfMailer.TextBody + "           Tshirt Size:  " + Request.Form("tshirt") + vbcrlf
