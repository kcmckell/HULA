...
<!--#include file="include/title_border_top.inc"-->
   <b>HULA - Member Network</b>
<!--#include file="include/title_border_bottom.inc"-->

<!--#include file="include/blurb_border_top.inc"-->
      <br><p>To access the HULA member network, please enter the password
	provided to you by your last league captain (or also available by
	contacting
	<a href="mailto:webmaster@hawaiiultimate.com">webmaster@hawaiiultimate.com</a>):
      <form method="POST" action="network.asp">
...
<!--#include file="include/network.inc"-->
